...
<html class="no-js" <?php language_attributes(); ?>>
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-110735208-2"></script>
        <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-110735208-2');
        </script>
        <!-- Google Tag Manager -->
        ...
        })(window,document,'script','dataLayer','GTM-58Z9FML');</script>
        ...
        <link href="https://fonts.googleapis.com/css?family=Cormorant+Garamond:600,700,700i" rel="stylesheet">
    ...
    <body <?php body_class('overflow-hidden'); ?>>
        ...
        <!-- Google Tag Manager (noscript) -->
            <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-58Z9FML"
